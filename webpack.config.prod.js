...
export default {
    ...
    module: {
        loaders: [
            ...
            {test: /\.css$/, exclude: /node_modules/, loader: ExtractTextPlugin.extract('style-loader!css-loader?modules&localIdentName=[name]__[local]___[hash:base64:5]')}, // css loader with modules activated
